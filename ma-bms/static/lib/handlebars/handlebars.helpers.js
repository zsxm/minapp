...
// 根据id获取合作经销商覆盖区域名称
Handlebars.registerHelper("provincename", function(id){
	var value = "";
	$.ajax({
		async: false,
		url: apis + "/zulin/province/name",
		data: {
			id : id,
			random : Math.random()
		},
...
// 根据id列表字符串（逗号分隔）获取合作经销商覆盖区域名称列表字符串（逗号分隔）
Handlebars.registerHelper("provincenames", function(ids){
	var value = "";
	$.ajax({
		async: false,
		url: apis + "/zulin/province/names",
		data: {
			ids : ids,
			random : Math.random()
		},
...
// 根据id获取合作经销商机械品牌名称
Handlebars.registerHelper("brandname", function(id){
	var value = "";
	$.ajax({
		async: false,
		url: apis + "/zulin/brand/name",
		data: {
			id : id,
			random : Math.random()
		},
...
// 根据id列表字符串（逗号分隔）获取合作经销商机械品牌名称列表字符串（逗号分隔）
Handlebars.registerHelper("brandnames", function(ids){
	var value = "";
	$.ajax({
		async: false,
		url: apis + "/zulin/brand/names",
		data: {
			ids : ids,
			random : Math.random()
		},
...
// 根据id获取合作经销商机械类型名称
Handlebars.registerHelper("typesname", function(id){
	var value = "";
	$.ajax({
		async: false,
		url: apis + "/zulin/types/name",
		data: {
			id : id,
			random : Math.random()
		},
...
// 根据id列表字符串（逗号分隔）获取合作经销商机械类型名称列表字符串（逗号分隔）
Handlebars.registerHelper("typesnames", function(ids){
	var value = "";
	$.ajax({
		async: false,
		url: apis + "/zulin/types/names",
		data: {
			ids : ids,
			random : Math.random()
		},
