...
var (
	ENTITY           = schema.TABLE("sys_dict", "字典")
	...
	ENTITY_DESCR     = ENTITY.COLUMN("descr", "描述")
	ENTITY_MKEY      = ENTITY.COLUMN("mkey", "键")
	ENTITY_MVAL      = ENTITY.COLUMN("mval", "值")
	ENTITY_FILTERS   = ENTITY.COLUMN("filters", "过滤")
