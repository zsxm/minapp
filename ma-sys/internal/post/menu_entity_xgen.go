...
var (
	MENU_ENTITY           = schema.TABLE("sys_post_menu", "岗位菜单")
	MENU_ENTITY_ID        = MENU_ENTITY.PRIMARY("id", "标识")
	MENU_ENTITY_MEMO      = MENU_ENTITY.COLUMN("memo", "备注")
	MENU_ENTITY_CREATES   = MENU_ENTITY.COLUMN("creates", "创建机构")
	MENU_ENTITY_CREATER   = MENU_ENTITY.CREATER("creater", "创建人员")
	MENU_ENTITY_CREATED   = MENU_ENTITY.CREATED("created", "创建时间")
	MENU_ENTITY_MODIFIER  = MENU_ENTITY.MODIFIER("modifier", "更新人员")
	MENU_ENTITY_MODIFIED  = MENU_ENTITY.MODIFIED("modified", "更新时间")
	MENU_ENTITY_VERSION   = MENU_ENTITY.VERSION("version", "乐观锁")
	MENU_ENTITY_DELETION  = MENU_ENTITY.DELETION("deletion", "删除标志")
	MENU_ENTITY_ARTIFICAL = MENU_ENTITY.COLUMN("artifical", "人造数据")
	MENU_ENTITY_HISTORY   = MENU_ENTITY.COLUMN("history", "历史数据")
	MENU_ENTITY_POST_ID   = MENU_ENTITY.COLUMN("post_id", "岗位ID")
	MENU_ENTITY_MENU_ID   = MENU_ENTITY.COLUMN("menu_id", "菜单ID")
)
