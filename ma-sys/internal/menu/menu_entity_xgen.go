...
var (
	ENTITY              = schema.TABLE("sys_menu", "菜单")
	ENTITY_ID           = ENTITY.PRIMARY("id", "标识")
	ENTITY_CODE         = ENTITY.COLUMN("code", "编号")
	ENTITY_NAME         = ENTITY.COLUMN("name", "名称")
	ENTITY_FULLNAME     = ENTITY.COLUMN("fullname", "全称")
	ENTITY_GENRE        = ENTITY.COLUMN("genre", "类型")
	ENTITY_LEAF         = ENTITY.COLUMN("leaf", "是否叶子")
	ENTITY_GRADE        = ENTITY.COLUMN("grade", "节点等级")
	ENTITY_ORDINAL      = ENTITY.COLUMN("ordinal", "排序")
	ENTITY_PARENT_ID    = ENTITY.COLUMN("parent_id", "父表主键")
	ENTITY_PARENT_IDS   = ENTITY.COLUMN("parent_ids", "父ID集")
	ENTITY_PARENT_CODES = ENTITY.COLUMN("parent_codes", "父编号集")
	ENTITY_PARENT_NAMES = ENTITY.COLUMN("parent_names", "父名称集")
	...
	ENTITY_HREF         = ENTITY.COLUMN("href", "链接")
	ENTITY_TARGET       = ENTITY.COLUMN("target", "目标")
	ENTITY_ICON         = ENTITY.COLUMN("icon", "图标")
	ENTITY_HIDDEN       = ENTITY.COLUMN("hidden", "隐藏")
	ENTITY_PERMISSION   = ENTITY.COLUMN("permission", "权限")
)
