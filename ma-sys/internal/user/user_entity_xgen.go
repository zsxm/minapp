...
var (
	ENTITY            = schema.TABLE("sys_user", "用户")
	...
	ENTITY_PASSWD     = ENTITY.COLUMN("passwd", "密码")
	ENTITY_GENRE      = ENTITY.COLUMN("genre", "类型")
	ENTITY_EMAIL      = ENTITY.COLUMN("email", "邮件")
	ENTITY_TEL        = ENTITY.COLUMN("tel", "电话")
	ENTITY_MOBILE     = ENTITY.COLUMN("mobile", "手机")
	ENTITY_AREA_ID    = ENTITY.COLUMN("area_id", "所属区域")
	ENTITY_ORG_ID     = ENTITY.COLUMN("org_id", "所属机构")
	ENTITY_LOGIN_NAME = ENTITY.COLUMN("login_name", "登录名")
	ENTITY_LOGIN_IP   = ENTITY.COLUMN("login_ip", "登录IP")
	ENTITY_LOGIN_TIME = ENTITY.COLUMN("login_time", "登录时间")
)
